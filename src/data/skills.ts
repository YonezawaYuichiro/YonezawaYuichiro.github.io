...
export const SKILL_CATEGORIES: SkillCategory[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Docker / Docker Compose", level: "使い方がわかる" },
            { name: "AWS (ECS, Lambda, RDS, S3 等)", level: "使い方がわかる" },
            { name: "SSH / SCP", level: "使い方がわかる" },
            { name: "Google Cloud", level: "使ったことがある" },
            { name: "Terraform", level: "使ったことがある" },
            { name: "Serverless Framework", level: "使ったことがある" },
    ...
    },
    {
        ...
        items: [
            ...
            { name: "9軸IMUセンサー (MPU9250)", level: "使ったことがある" },
            { name: "UDP通信", level: "使ったことがある" },
            { name: "Zephyr RTOS", level: "使ったことがある" },
            { name: "pigpio / gpiozero", level: "使ったことがある" },
        ],
    },
    {
